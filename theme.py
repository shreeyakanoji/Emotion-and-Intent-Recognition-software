...
/* ---- content sits above the swirl automatically now that the swirl
   layers use z-index:-1 inside .stApp's own stacking context; the glass
   card below is a cosmetic bonus on top of that, applied defensively to
   several possible Streamlit DOM shapes since internal class names can
